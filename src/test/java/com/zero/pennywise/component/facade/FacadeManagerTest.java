...
//
//    // when
//    UserEntity response = userFacade.findByUserId(USER_ID);
//
//    // then
...
//        () -> userFacade.findByUserId(USER_ID));
//
//    // then
//    assertEquals(
...
//
//    // when
//    UserEntity response = userFacade.getUserByAccessToken(request);
//
//    // then
//    assertEquals(response, user);
//    assertEquals(response.getUserId(), user.getUserId());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.getUserByAccessToken(request));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    UserEntity response = userFacade.createUser(signUpDTO);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.createUser(signUpDTO));
//
//    // then
//    assertEquals(
...
//
//    // when
//    UserEntity response = userFacade.validateLoginData(loginDTO);
//
//    // then
//    assertEquals(response.getEmail(), user.getEmail());
//    assertEquals(response.getPassword(), user.getPassword());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.validateLoginData(loginDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    UserEntity response = userFacade.updateUserInfo(request, updateDTO);
//
//    // then
//    assertEquals(response.getEmail(), expectedUser.getEmail());
//    assertEquals(response.getPassword(), expectedUser.getPassword());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.updateUserInfo(request, updateDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    userFacade.deleteAllUserData(request);
//
//    // then
...
//
//    // when
//    CategoryEntity response = userFacade.getCategoryByUserAndCategoryName(user, CATEGORY_NAME);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.getCategoryByUserAndCategoryName(user, CATEGORY_NAME));
//
//    // then
//    assertEquals(
...
//
//    // when
//    PageResponse<String> response = userFacade.getUserCategoryList(request, PAGE_NUM);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.getUserCategoryList(request, PAGE_NUM));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    CategoryEntity response = userFacade.createCategory(request, CATEGORY_NAME);
//
//    // then
//    assertEquals(response.getCategoryName(), category.getCategoryName());
//    assertEquals(response.getUser(), category.getUser());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.createCategory(request, CATEGORY_NAME));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    CategoryEntity response = userFacade.updateCategory(request, updateCategoryDTO);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.updateCategory(request, updateCategoryDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    userFacade.deleteCategory(request, CATEGORY_NAME);
//
//    // then
...
//
//    // when
//    PageResponse<Transactions> response = userFacade
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.getTransactionList(request, transactionInfoDTO, PAGE_NUM));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    TransactionEntity response = userFacade.createTransaction(request, transactionDTO);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.createTransaction(request, transactionDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    userFacade.deleteTransaction(request, TRANSACTION_ID);
//
//    // then
...
//
//    // when
//    PageResponse<Budgets> response = userFacade.getBudgetList(request, CATEGORY_NAME, PAGE_NUM);
//
//    // then
//    assertEquals(expectedResponse.getPageNumber(), response.getPageNumber());
//    assertEquals(expectedResponse.getTotalPage(), response.getTotalPage());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.getBudgetList(request, CATEGORY_NAME, PAGE_NUM));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    BudgetEntity response = userFacade.createBudget(request, budgetDTO);
//
//    // then
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.createBudget(request, budgetDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    BudgetEntity response = userFacade.updateBudget(request, updateBudgetDTO);
//
//    // then
//    assertEquals(expectedBudget.getUser(), response.getUser());
//    assertEquals(expectedBudget.getCategory(), response.getCategory());
...
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
//        () -> userFacade.updateBudget(request, updateBudgetDTO));
//
//    // then
//    assertEquals(
//        FailedResultCode.USER_NOT_FOUND.getStatus(),
...
//
//    // when
//    userFacade.deleteBudget(request, BUDGET_ID);
//
//    // then
