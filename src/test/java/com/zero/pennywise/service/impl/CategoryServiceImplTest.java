...
//    // given
//    when(userFacade.getUserCategoryList(request, PAGE)).thenReturn(pageResponse);
//
//    // when
...
//    // given
//    when(userFacade.getUserCategoryList(request, PAGE)).thenThrow(new GlobalException(
...
//  void createCategory() {
//    // given
//    when(userFacade.createCategory(request, CATEGORY_NAME)).thenReturn(category);
//
//    // when
...
//    // given
//    when(userFacade.createCategory(request, CATEGORY_NAME)).thenThrow(new GlobalException(
//        FailedResultCode.USER_NOT_FOUND));
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
...
//  void updateCategory() {
//    // given
//    when(userFacade.updateCategory(request, updateCategoryDTO)).thenReturn(category);
//
//    // when
...
//    // given
//    when(userFacade.updateCategory(request, updateCategoryDTO)).thenThrow(new GlobalException(
//        FailedResultCode.USER_NOT_FOUND));
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
...
//        .when(userFacade).deleteCategory(request, CATEGORY_NAME);
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
