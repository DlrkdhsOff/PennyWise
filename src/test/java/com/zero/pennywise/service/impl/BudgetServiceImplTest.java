...
//  void getBudget() {
//    // given
//    when(userFacade.getBudgetList(request, CATEGORY_NAME, PAGE)).thenReturn(pageResponse);
//
//    // when
...
//    // given
//    when(userFacade.getBudgetList(request, CATEGORY_NAME, PAGE))
...
//  void createBudget() {
//    // given
//    when(userFacade.createBudget(request, budgetDTO)).thenReturn(budget);
//
//    // when
...
//    // given
//    when(userFacade.createBudget(request, budgetDTO))
//        .thenThrow(new GlobalException(FailedResultCode.USER_NOT_FOUND));
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
...
//  void updateBudget() {
//    // given
//    when(userFacade.updateBudget(request, updateBudgetDTO)).thenReturn(budget);
//
//    // when
...
//    // given
//    when(userFacade.updateBudget(request, updateBudgetDTO))
//        .thenThrow(new GlobalException(FailedResultCode.USER_NOT_FOUND));
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
...
//        .when(userFacade).deleteBudget(request, BUDGET_ID);
//
//    // when
//    GlobalException exception = assertThrows(GlobalException.class,
