...
//
//    if (balance.getTotalExpensesAmount() < 0) {
//      String message = transaction.getCategory().getCategoryName() + " 예산을 초과 했습니다.";
...
//      redisTemplate.convertAndSend("notifications", new WaringMessageDTO(user.getUserId(), message));
//    }
//    saveBalance(balance);
