...
//
//  // 예산 목록 조회
//  public PageResponse<Balances> getBalance(UserEntity user, int page) {
//    List<Balances> balances = redisRepository.findByUserId(user.getId())
//        .map(BalanceEntity::getBalances)
//        .orElse(new ArrayList<>());
//
//    return PageResponse.of(balances, page);
//  }
//
//  // 생성한 예산 등록
